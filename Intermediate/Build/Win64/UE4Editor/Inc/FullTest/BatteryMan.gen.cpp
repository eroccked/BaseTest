...
// Cross Module References
	FULLTEST_API UClass* Z_Construct_UClass_ABatteryMan_NoRegister();
	FULLTEST_API UClass* Z_Construct_UClass_ABatteryMan();
...
// End Cross Module References
	DEFINE_FUNCTION(ABatteryMan::execOnBeginOverlap)
	{
		...
		P_GET_STRUCT_REF(FHitResult,Z_Param_Out_SweepResults);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->OnBeginOverlap(Z_Param_HitComp,Z_Param_OtherActor,Z_Param_OtherComp,Z_Param_OtherBodyIndex,Z_Param_bFromSweep,Z_Param_Out_SweepResults);
		P_NATIVE_END;
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_SweepResults_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_SweepResults;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ABatteryMan_OnBeginOverlap_Statics::NewProp_SweepResults_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ABatteryMan_OnBeginOverlap_Statics::NewProp_SweepResults = { "SweepResults", nullptr, (EPropertyFlags)0x0010008008000182, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(BatteryMan_eventOnBeginOverlap_Parms, SweepResults), Z_Construct_UScriptStruct_FHitResult, METADATA_PARAMS(Z_Construct_UFunction_ABatteryMan_OnBeginOverlap_Statics::NewProp_SweepResults_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_ABatteryMan_OnBeginOverlap_Statics::NewProp_SweepResults_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ABatteryMan_OnBeginOverlap_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ABatteryMan_OnBeginOverlap_Statics::NewProp_SweepResults,
	};
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_Power_Trashold_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_Power_Trashold;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ABatteryMan_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ABatteryMan_OnBeginOverlap, "OnBeginOverlap" }, // 3516037267
	};
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABatteryMan_Statics::NewProp_Power_Trashold_MetaData[] = {
		{ "Category", "BatteryMan" },
		{ "ModuleRelativePath", "BatteryMan.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ABatteryMan_Statics::NewProp_Power_Trashold = { "Power_Trashold", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABatteryMan, Power_Trashold), METADATA_PARAMS(Z_Construct_UClass_ABatteryMan_Statics::NewProp_Power_Trashold_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABatteryMan_Statics::NewProp_Power_Trashold_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ABatteryMan_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABatteryMan_Statics::NewProp_Power_Trashold,
	...
	IMPLEMENT_CLASS(ABatteryMan, 437536378);
	template<> FULLTEST_API UClass* StaticClass<ABatteryMan>()
	{
		return ABatteryMan::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ABatteryMan(Z_Construct_UClass_ABatteryMan, &ABatteryMan::StaticClass, TEXT("/Script/FullTest"), TEXT("ABatteryMan"), false, nullptr, nullptr, nullptr);
