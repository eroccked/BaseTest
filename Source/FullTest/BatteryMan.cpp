...
void ABatteryMan::Tick(float DeltaTime)
{
	...
	Power -= DeltaTime * Power_Trashold;
...
void ABatteryMan::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Junp", IE_Released, this, &ACharacter::Jump);
...
void ABatteryMan::OnBeginOverlap(UPrimitiveComponent* HitComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResults)
{
